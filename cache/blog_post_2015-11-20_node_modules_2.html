        ...
        <div class="row">
            <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                <div class="post-heading smaller-heading">
                    ...
                    <span class="meta">Posted by <a data-bind="attr: {href: authorLink}, text: author" href="#/about">Joel Lord</a> on <span data-bind="text: formattedDate">November 20th, 2015</span></span>
                </div>
            </div>
        </div>
    </div>
