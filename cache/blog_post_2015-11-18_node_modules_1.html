        ...
        <div class="row">
            <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                <div class="post-heading smaller-heading">
                    ...
                    <span class="meta">Posted by <a data-bind="attr: {href: authorLink}, text: author" href="#/about">Joel Lord</a> on <span data-bind="text: formattedDate">November 18th, 2015</span></span>
                </div>
            </div>
        </div>
    </div>
...
<p>In the next posts, I will describe how to test this module and how to use npm to create a package that is ready to get published (<a href="#!blog/post/2015-11-20_node_modules_2">part 2</a>).</p>
</div>
        </div>
    </div>
</article>
